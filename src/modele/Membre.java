...
public class Membre {
    ...
    private List<Object> empruntsActifs;

    public Membre(String idMembre, String nom, String prenom, String email, LocalDate dateInscription)
    ...
    public void ajouterEmprunt(Object emprunt) { empruntsActifs.add(emprunt); }
    public void retirerEmprunt(Object emprunt) { empruntsActifs.remove(emprunt); }
